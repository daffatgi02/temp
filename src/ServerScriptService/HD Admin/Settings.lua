...
return {
	...
	Ranks = {
		{ 5, "Owner" }, -- kosongi aja otomatis owner kamu
		{ 4, "HeadAdmin", { "9612593502" } }, -- HeadAdmin
		{
			3,
			"Admin",
			{ "9240638873", "9118581801", "9241659321", "8222796361", "8825849958", "8807634689", "9596985133" },
		}, -- semua Admin
		{ 2, "Mod", {} }, -- kosong
		{ 1, "VIP", { "9065140275", "9176556789", "9060107999" } }, -- VIP spesifik
		{ 0, "NonAdmin" }, -- default
	},
	...
	RankRequiredToViewCommandsIcon = 3, -- Minimum rank to view the icon which opens the Commands-Only page. This is hidden if the user can view the dashboard.
	RankRequiredToViewDashboardIcon = 3, -- Minimum rank to view the icon which opens the Dashboard

	NoticeSoundId = 2865227271, -- The SoundId for notices.
	NoticeVolume = 0.1, -- The Volume for notices.
	NoticePitch = 0.5, -- The Pitch/PlaybackSpeed for notices.
	...
	AlertVolume = 0.2, -- The Volume for alerts.
	AlertPitch = 0.5, -- The Pitch/PlaybackSpeed for alerts.
