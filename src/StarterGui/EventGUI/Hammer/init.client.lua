...
local u4 = Vector3.new(63.8, 38.244, 805.2); --Giant Target Position 
...
local function u7(p5, p6, p7, p8)
	local v11 = game.ReplicatedStorage.VFX.Templates.UltraHammerGiant:Clone();
...
-- SECURITY FIX: Only receive events from server, never fire them
require(game.ReplicatedStorage.Remotes).OnClientEvent("FireSmite"):Connect(function(p19, p20, p21, p22)
	print("Smite effect triggered by server for:", p19)
	u7(p19, p20, p21, p22);
end);